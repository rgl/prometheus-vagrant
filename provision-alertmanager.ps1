...
$archiveUrl = 'https://github.com/prometheus/alertmanager/releases/download/v0.16.2/alertmanager-0.16.2.windows-amd64.tar.gz'
$archiveHash = 'ec295f61fed46c0e1a482f04cf0d15eabe1217ecf5a9d9a4eee31e1c07704039'
