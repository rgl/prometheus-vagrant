...
$archiveUrl = 'https://github.com/prometheus/alertmanager/releases/download/v0.15.1/alertmanager-0.15.1.windows-amd64.tar.gz'
$archiveHash = '4974664c7d343274b4476bb0d632a1f5aaf518cb98c865da178fc5122ca6cf9f'
