...
$archiveUrl = 'https://github.com/prometheus/alertmanager/releases/download/v0.19.0/alertmanager-0.19.0.windows-amd64.tar.gz'
$archiveHash = '87cd6313c0d04841954f5c40b13eab63a3d26d91041d0f6cfaa76e1b2c92a0ef'
