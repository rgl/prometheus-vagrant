...
$archiveUrl = 'https://github.com/prometheus/alertmanager/releases/download/v0.15.0/alertmanager-0.15.0.windows-amd64.tar.gz'
$archiveHash = 'a4b17ffcb847659e0d99c6971c652d420763e150e671131e7afcc1732f708318'
