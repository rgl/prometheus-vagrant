...
$archiveUrl = 'https://github.com/prometheus/alertmanager/releases/download/v0.14.0/alertmanager-0.14.0.windows-amd64.tar.gz'
$archiveHash = 'd6d408e14451eba6f4db6717312b10ec9b20a28251c8058ca7b2589a4bad5a6d'
