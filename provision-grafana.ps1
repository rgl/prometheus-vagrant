...
$archiveUrl = 'https://s3-us-west-2.amazonaws.com/grafana-releases/release/grafana-4.6.1.windows-x64.zip'
$archiveHash = '7bac2ec7316477adb9a7688644fbd8d6cb8716a8938cade97ed37bb1769538f7'
