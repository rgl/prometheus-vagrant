...
$archiveUrl = 'https://s3-us-west-2.amazonaws.com/grafana-releases/release/grafana-5.0.3.windows-x64.zip'
$archiveHash = 'ae141e4ba9f3db5a9d13c8ea710b6f4bacce4be0f688df3047d1c2e793df81cc'
