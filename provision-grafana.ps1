...
$archiveUrl = 'https://dl.grafana.com/oss/release/grafana-6.1.4.windows-amd64.zip'
$archiveHash = 'e886227edbab9e7a7299857d1760c8e45998a2775bc220b5dc4435e72ae53832'
