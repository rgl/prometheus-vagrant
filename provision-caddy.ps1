...
$archiveUrl = 'https://github.com/mholt/caddy/releases/download/v0.11.1/caddy_v0.11.1_windows_amd64.zip'
$archiveHash = '293cad875b646b4f63f48369a8e1a91eec37e9e2e7e05602d51cbad8e0214981'
