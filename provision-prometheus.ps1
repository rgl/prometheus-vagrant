...
$archiveUrl = 'https://github.com/prometheus/prometheus/releases/download/v2.14.0/prometheus-2.14.0.windows-amd64.tar.gz'
$archiveHash = '0180f767df0a3a855b98e3e3f6600c35af4486cc07d7f5f26b31e203f8a9a249'
