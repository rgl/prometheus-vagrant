...
$archiveUrl = 'https://github.com/prometheus/prometheus/releases/download/v2.3.2/prometheus-2.3.2.windows-amd64.tar.gz'
$archiveHash = '6eaefc996a1f6820b782a608f916c36725887a6f1dac604a3fe007cd6f8c4005'
