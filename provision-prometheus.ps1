...
$archiveUrl = 'https://github.com/prometheus/prometheus/releases/download/v2.3.0/prometheus-2.3.0.windows-amd64.tar.gz'
$archiveHash = '463aaea6d70590e44e973f7930cbfaa4bf35b2f5813de1183b6fa91db4340dcf'
