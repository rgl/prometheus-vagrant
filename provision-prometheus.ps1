...
$archiveUrl = 'https://github.com/prometheus/prometheus/releases/download/v2.9.2/prometheus-2.9.2.windows-amd64.tar.gz'
$archiveHash = '95cba8047a683a21abf99732d97f6a5f1ae14fedd496abd4745dac9f8554b4c4'
